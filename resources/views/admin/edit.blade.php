...
@section('content')
    ...
    <div class="flex h-screen items-center justify-center mt-40 sm:mt-5 mb-40 ">
        <div class="grid bg-white rounded-lg shadow-2xl w-11/12 md:w-9/12 lg:w-1/2">
            <div class="flex justify-center py-4">
                <div class="  ">
                    <img src="https://i.ibb.co/CbHhPbW/Logo-1.png" alt="Logo-1" style="width: 80px;" id="imagenLogo2" />
                </div>
            </div>
