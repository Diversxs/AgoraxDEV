        ...
        <div class="overflow-hidden shadow-lg flex flex-col md:flex-row items-center m-5 rounded-3xl">
            <img class="w-100" src="{{$event->picture}}" alt="Sunset in the mountains">
                <div class="px-6 py-4">
                    ...
                    <button class="mr-2 my-2 bg-green-600 hover:bg-red-700 text-white text-sm px-4 py-2 border rounded-full" type="submit">Highlight Event</button>
                        ...
                        @method('DELETE')
                            <a href="{{route('admin_delete',$event->id)}}">
                                <button class="uppercase p-3 flex items-center bg-yellow-600 text-blue-50 max-w-max shadow-sm hover:shadow-lg hover:bg-red-800 rounded-full w-12 h-12 ">
