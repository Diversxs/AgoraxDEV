...
@section('content')
    ...
    <div class="flex h-screen items-center justify-center p-0 m-0" id="containergrande">
                ...
                <div class="containerEventUpload">
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-bold mb-1">Upload
                            Photo</label>
                        <div class='flex items-center justify-start w-200'>
                            <label
                                ...
                                <div class='flex flex-col items-center '>
                                    <img id="output_image" style="width: 8rem;" />
