...
<a href="{{ route('show_event', $event->id) }}">
    ...
    <div class="container flex items-center justify-center md:ml-20 rounded-3xl bg-blue-100 mb-20">
        <div class="overflow-hidden shadow-3lg flex flex-col md:flex-row items-center m-5 rounded-3xl">
            ...
            <section>
                <div class="p-0 md:p-5 mt-10 mb-0 md:mb-10 text-blue-800 flex-auto text-2xl md:text-4xl text-center font-bold ">
                    <h1>{{ $event->title }}</h1>
                </div>
