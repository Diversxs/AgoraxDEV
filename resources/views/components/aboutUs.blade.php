    ...
    <div class=" inset-0 bg-indigo-900 mix-blend-multiply p-6 mb-4">
        <div class="flex  justify-center items-center px-2  mx-auto my-auto max-w-7xl md:max-h-2xl md:py-6 flex sm:flex-row flex-col">
            <div class="flex justify-center items-center flex-col sm:mr-10 mr-0">
                <h1 class="text-4xl text-white md:text-5xl font-bold content-center p-3">About us</h1>
                <p class="content-center text-2xl text-gray-100 p-3">
                    Learn a bit from Agorax developers
                </p>
                
            </div>
            <div>
                <img class=" w-full h-full rounded-3xl p-3"
                    src="https://onlinemasters.ohio.edu/wp-content/uploads/2018/03/the-fundamentals-of-a-human-resource-department-image.jpg"
    ...
    <div class="flex md:flex-row flex-col items-center justify-center mt-20mt-5 md: mb-40 justify-center ">
        <div class="p-5 bg-orange-200 flex content-center items-center justify-center">
            <div class="bg-indigo-900 rounded-lg shadow-2xl md:flex flex-col items-center justify-center">
                ...
                <div class="p-6 flex flex-col content-center items-center justify-center">
                    <h2 class="font-bold text-xl md:text-3xl mb-2 text-white">Leah Calafell</h2>
                    <p class="text-white text-center">
                        Leah es Licenciada en Ciencias Tabaquiles en la Universidad de Andorra. Sus aficiones son el esquí y
                        la comida peruana, aunque dedica la mayor parte del tiempo a la exportación de tabaco marca
                        L'andorrien
                    </p>
                </div>
