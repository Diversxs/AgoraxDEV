  ...
  @section('content')
      ...
      <div class="buttons flex justify-around">
          <a href="{{ route('passedEvents') }}">
              <button class="ml-8 my-8 bg-green-600 hover:bg-green-700 text-white text-sm px-4 py-2  border rounded-full"
                          ...
                          <div class="flex flex-col sm:flex-row justify-between items-center sm:items-around ">
                              ...
                              @if ($event->isSubcribed($user) === false)
                                  <a class="bg-green-600 hover:bg-red-700 text-white text-sm px-4 py-2  border rounded-full"
                                      method="GET" href="{{ route('subscribe', $event->id) }}"><button type="submit">Book
                                          this Event</button></a>
                              @endif
